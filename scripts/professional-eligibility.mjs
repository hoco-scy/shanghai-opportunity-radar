...
export function evaluateProfessionalEligibility(value) {
  ...
  for (const [pattern, basis, reason] of [[OPEN_MAJOR,"open","官方条件明确不限专业"],[EXACT_MAJOR,"exact","官方条件明确列出生物医学工程或等同专业"],[ADJACENT_MAJOR,"adjacent","官方条件列出与生物医学工程相近的生物工程或医疗器械专业口径"],[BROAD_ENGINEERING,"broad-engineering","官方条件明确接受工学、理工或相近工程门类"]]) {
    const matched = evidence(pattern, text); if (matched) return { eligible: true, basis, evidence: matched, reason };
  }
